function fitVal = Manuscript_Simulation_3_PRP_fun(inputArg)
...
tasksToPerform
        ...
        batch_log(numHiddenIdx, rep).funcDependence.task1RT_log = task1RT_log;
        batch_log(numHiddenIdx, rep).funcDependence.task1Accuracy_log = task1Accuracy_log;
        batch_log(numHiddenIdx, rep).funcDependence.task1Iterations_log = task1Iterations_log;
        batch_log(numHiddenIdx, rep).funcDependence.task2RT_log = task2RT_log;
        batch_log(numHiddenIdx, rep).funcDependence.task2Accuracy_log = task2Accuracy_log;
        batch_log(numHiddenIdx, rep).funcDependence.task2Iterations_log = task2Iterations_log;
        ...
        batch_log(numHiddenIdx, rep).independence.task1RT_log = task1RT_log;
        batch_log(numHiddenIdx, rep).independence.task1Accuracy_log = task1Accuracy_log;
        batch_log(numHiddenIdx, rep).independence.task1Iterations_log = task1Iterations_log;
        batch_log(numHiddenIdx, rep).independence.task2RT_log = task2RT_log;
        batch_log(numHiddenIdx, rep).independence.task2Accuracy_log = task2Accuracy_log;
        batch_log(numHiddenIdx, rep).independence.task2Iterations_log = task2Iterations_log;
...
save(['logfiles/Part1/PsychReview_Part1_Sim4_PRP_' num2str(NPathways) 'P' num2str(NFeatures) 'F_' num2str(length(tasksToPerform)) 'tasks_' num2str(log_version) '_h' num2str(numHiddenUnits(1)) '_r' num2str(rep)]);

...
bar_colors_edge=zeros(N_grps, 3); % get some distinguishable colors for the bars!
        ...
        if numel(varargin)>0 % optional input arguments are provided
            ...
            while ~isempty(varargin)
                ...
                switch varargin{1}
                    ...
                    case 'bar_colors_edge'
                        bar_colors_edge=varargin{2};
...
for grp=1:N_grps
    hb(grp)=bar( ...
        ...
        'EdgeColor',bar_colors_edge(grp,:), ... % color parameter

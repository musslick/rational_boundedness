function [outfile] = Manuscript_Simulation_1_sharedRepresentation_fun(inputArg, hiddenArg, silence)

% uncomment and add this path to your environment.
% addpath('/home/username/RTDist_1.0.0-rc2/MATLAB');
...
%     rng(0);
    ...
    if(isa(inputArg, 'char'))
        numGraphsPerSpec = 40;
        graphFolder = 'GraphGeneration/shared/edgelists';
...
%     MultiTask= sum(findMIS(logical(A_dual),[1:m]));
    ...
    outfile = ['logfiles/Part1/PsychReview_Part1_Sim1_sharedRepresentation_h' num2str(nHidden) '_' graphSpecsFolder '_' samplingFolder '_A' num2str(A_ID) '_' num2str(log_version) '.mat'];

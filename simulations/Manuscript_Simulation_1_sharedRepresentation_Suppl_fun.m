function fitVal = Manuscript_Simulation_1_sharedRepresentation_Suppl_fun(inputArg)

% Manuscript FIG_DEPENDENCY_RESULTS SUPPLEMENTARY
...
save(['logfiles/Part1/PsychReview_Part1_Sim1_sharedRepresentation_Suppl_' num2str(NPathways) 'P' num2str(NFeatures) 'F_' num2str(length(tasksToPerform)) 'tasks_' num2str(log_version) '_h' num2str(numHiddenUnits(1)) '_r' num2str(rep)]);

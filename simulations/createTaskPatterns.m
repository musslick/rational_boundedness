function [inputSgl, tasksSgl, trainSgl, tasksIdxSgl, stimIdxSgl, inputSgl_mask, tasksSgl_mask, trainSgl_mask, multiCap] = createTaskPatterns(NPathways, NFeatures, samples, sdScale, sameStimuliAcrossTasks, varargin)

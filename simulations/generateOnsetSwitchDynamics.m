function [MSE_2, MSE_1, accuracy_2, accuracy_1, pcorrect_2, pcorrect_1, correctResponseAct_2, correctResponseAct_1, interferenceResponseAct_2, interferenceResponseAct_1, correctResponseActSum_2, correctResponseActSum_1, interferenceResponseActSum_2, interferenceResponseActSum_1] = generateOnsetSwitchDynamics(task1, task2, taskNet, NPathways, NFeatures, multiCap, tau, iterations_taskSwitching, onset)
        ...
        taskStream = repmat(multitask_pattern, size(relevantInputPatterns,1), 1, iterations_taskSwitching);
        taskStream(:,:,1) = 0;
        taskStream(:,:,2:onset) = repmat(task1_pattern, size(relevantInputPatterns,1), 1, length(2:onset));
        ...
        inputDim_2 = ceil(task1/taskNet.NPathways); 
        relevantOutputFeatures_1 = (NFeatures*(outputDim_1-1)+1) : (NFeatures*outputDim_1);
        relevantInputFeatures_1 = (NFeatures*(inputDim_2-1)+1) : (NFeatures*inputDim_2);
